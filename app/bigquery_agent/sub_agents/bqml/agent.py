...
# Configure BigQueryToolset with WriteMode.ALLOWED (permits CREATE MODEL for BQML)
bigquery_tool_filter = [ADK_BUILTIN_BQ_EXECUTE_SQL_TOOL]
bigquery_tool_config = BigQueryToolConfig(
    write_mode=WriteMode.ALLOWED,  # CRITICAL: Only BQML agent has write access for CREATE MODEL
...
bqml_agent = LlmAgent(
    ...
    tools=[bq_execute_sql, check_bq_models, rag_response],

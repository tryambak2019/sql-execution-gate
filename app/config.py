...
if os.getenv("GOOGLE_API_KEY"):
    ...
    # Vertex AI mode: Prefer an explicitly configured project. ADC is only a
    # fallback for discovering the project ID; importing the application must
    # not require credentials (for example, during unit-test collection).
...
# Cloud Build imports this value and passes it to Terraform. Keep it as an
# integer because Cloud Monitoring expects a duration in whole seconds.
